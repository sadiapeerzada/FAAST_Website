        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-300 leading-relaxed">
              FAAST is Aligarh Muslim University's premier FinTech club, bringing together 
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            ...
            <p className="text-xl text-gray-400 text-center mb-16">
              Each letter represents a core pillar of our club's expertise
            </p>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="space-y-6 text-gray-300 text-lg leading-relaxed">
              ...
              <p>
                What started as a small group of enthusiasts has grown into AMU's most dynamic 
